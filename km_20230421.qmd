...
- [강의노트 (오전)](https://hackmd.io/a-M3VOO1T8uxY4oohrNyzQ)
- [강의노트 (오후)](https://hackmd.io/EnuEh84dRP-j8ckYJGDtzA)
...
```{mermaid}
flowchart LR
    A[강의 PPT] --> B[실습: 글쓰기 <br> 개회사]
    B --> C[실습: 글쓰기 <br> 보도자료]
    C --> D[실습: 그리기]
    D --> E["심화(선택)"]

click A href "https://r2bit.com/bitSlide/slideshow/202304-gpt/#/title-slide"
click C href "https://r2bit.com/chatGPT/prompt_in_practice.html"
click E href "https://r2bit.com/chatGPT/"
...
- [이전 참여자 명작 감상](https://hackmd.io/@_NnKkWt7T5iYIToOD1QWRg/SJMy0V8Z3)
- Text-to-Image 그리기: <https://www.bing.com/images/create/>
- [퀵 드로우](https://quickdraw.withgoogle.com/)
- [티처블 머신(teachable machine)](https://teachablemachine.withgoogle.com/)
- [딥 드림 제너레이터](https://deepdreamgenerator.com/)

# 공유의 장

- [오전교육](https://bit.ly/3oeEmgt)
- [오후교육](http://bit.ly/3KC1NYn)
